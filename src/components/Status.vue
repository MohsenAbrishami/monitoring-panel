        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-4">
            <div class="h-28 bg-red-100 p-2 rounded-lg">
                ...
                <div class="pt-4">
                    ...
                    <img
                        ...
                        src="https://raw.githubusercontent.com/MohsenAbrishami/monitoring-panel/main/src/assets/cpu-icon.png"
                    >
                </div>
            </div>
            <div class="h-28 bg-green-100 p-2 rounded-lg">
                ...
                <div class="pt-4">
                    ...
                    <img
                        class="inline-block float-right w-12"
                        src="https://raw.githubusercontent.com/MohsenAbrishami/monitoring-panel/main/src/assets/ram-icon.png"
                    >
                </div>
            </div>
            <div class="h-28 bg-green-100 p-2 rounded-lg">
                ...
                <div class="pt-4">
                    ...
                    <img
                        class="inline-block float-right w-12"
                        src="https://raw.githubusercontent.com/MohsenAbrishami/monitoring-panel/main/src/assets/harddisk-icon.png"
                    >
                </div>
            </div>
            <div class="h-28 bg-red-100 p-2 rounded-lg">
                ...
                <div class="pt-4">
                    ...
                    <img
                        class="inline-block float-right w-12"
                        src="https://raw.githubusercontent.com/MohsenAbrishami/monitoring-panel/main/src/assets/web-server-icon.png"
                    >
                </div>
            </div>
            <div class="h-28 bg-green-100 p-2 rounded-lg">
